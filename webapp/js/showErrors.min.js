...
(function () {
    ...
    a = angular.module("ui.bootstrap.showErrors", []), a.directive("showErrors", ["$timeout", "showErrorsConfig", "$interpolate", function (a, b, c) {
        ...
        return e = function (a) {
            ...
            var i, j, k, l, m, n, o, p;
            if (i = !1, m = b.$eval(g.showErrors), n = d(m), p = e(m), j = f[0].querySelector(".form-control[name]"), l = angular.element(j), k = c(l.attr("name") || "")(b), !k)throw"show-errors element has no child input elements with a 'name' attribute and a 'form-control' class";
            ...
            restrict: "A", require: "^form", compile: function (a, b) {
        ...
        a = !1, b = "blur", this.showSuccess = function (b) {
            ...
            return {showSuccess: a, trigger: b}
        }
    })
}).call(this);